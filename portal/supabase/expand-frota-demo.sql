-- ============================================================
-- expand-frota-demo.sql
-- Expande a frota de 20 modelos únicos para 78 unidades físicas
-- Mantém os 20 IDs originais (referenciados pelos 150 pedidos)
-- renomeando-os para "#01" e inserindo unidades #02, #03, etc.
--
-- Distribuição resultante: ~60% reservado | 15% indisponivel | 25% disponivel
--
